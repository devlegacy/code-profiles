...
- bug fixed for error that cannot display anything [#353](https://github.com/d-kimuson/ts-type-expand/issues/353)
...
- fixed bug that type expansion of function arguments [#21](https://github.com/d-kimuson/ts-type-expand/issues/21)
