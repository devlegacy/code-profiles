...
function makeDocument(lines, options = {}) {
    return vscode_languageserver_textdocument_1.TextDocument.create(options.uri || 'index.scss', options.languageId || 'scss', options.version || 1, Array.isArray(lines) ? lines.join('\n') : lines);
}
