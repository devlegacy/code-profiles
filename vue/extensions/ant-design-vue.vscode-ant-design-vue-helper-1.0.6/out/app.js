...
const ui_attributes_js_1 = require("./config/ui-attributes.js");
...
class AntdvDocsContentProvider {
    constructor() {
...
exports.AntdvDocsContentProvider = AntdvDocsContentProvider;
class AntdvCompletionItemProvider {
    constructor() {
        this.tagReg = /<([\w-]+)\s+/g;
        this.attrReg = /(?:\(|\s*)(\w+)=['"][^'"]*/;
        this.tagStartReg = /<([\w-]*)$/;
    ...
    getAttrItem(tag, attr) {
        return ui_attributes_js_1.default[`${tag}/${attr}`] || ui_attributes_js_1.default[attr];
    }
...
exports.AntdvCompletionItemProvider = AntdvCompletionItemProvider;
